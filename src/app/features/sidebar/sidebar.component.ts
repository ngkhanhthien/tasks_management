      ...
      <div class="nav-bar">
        <div class="nav-top">
          ...
          <nav class="nav-items">
            ...
            <button class="nav-item" title="Eisenhower Matrix">
            ...
            <button class="nav-item" title="Pomodoro">
            ...
            <button class="nav-item" title="Habit">
            ...
            <button class="nav-item" title="Search">
        ...
        <div class="nav-bottom">
          <button class="nav-item" title="Sync">
          ...
          <button class="nav-item" title="More">
